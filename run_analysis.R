...
names(mean.std.activity) <- names

#moving subject and activity column in front
mean.std.activity <- mean.std.activity[ ,c(67,68,1:66)]
...
write.table(mean.subject.activity,file="mean_subject_activity.txt", quote=F, rowname=F)       
